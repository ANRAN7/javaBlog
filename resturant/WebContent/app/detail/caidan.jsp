					...
					<c:forEach items="${requestScope.pageBean.pageData }" var="food">
					   <li>
					     <dl>
					        ...
					        <dd class="f1">
					          <a  href="${pageContext.request.contextPath }/index?method=getFoodDetail&food=${food.id }">${food.foodName }</a>
					          </dd>
					         <dd class="f2">
					          <a  href="${pageContext.request.contextPath }/index?method=getFoodDetail&food=${food.id }">${food.price }</a>
					          </dd>
					     </dl>
					   </li>
					</c:forEach>
